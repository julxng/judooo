      ...
      <JudoooNavbar
        ...
        actions={
          <>
            ...
            <JudoooButton variant="default">Join Judooo</JudoooButton>
          </>
        }
      />
          ...
          <main className="jd:flex jd:flex-col jd:gap-6">
              ...
              <div className="jd:relative jd:z-10 jd:grid jd:gap-8 lg:jd:grid-cols-[minmax(0,1.15fr)_320px]">
                <div className="jd:flex jd:flex-col jd:gap-5">
                  ...
                  <div className="jd:flex jd:flex-wrap jd:gap-3">
                    <JudoooButton variant="default" size="lg" onClick={() => setIsModalOpen(true)}>
                      Open Modal Demo
                    </JudoooButton>
            ...
            <section className="jd:grid jd:gap-6 xl:jd:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
              <div className="jd:flex jd:flex-col jd:gap-6">
                ...
                >
                  <div className="jd:flex jd:flex-wrap jd:gap-3">
                    <JudoooButton variant="default">Bid now</JudoooButton>
                ...
                <JudoooCard
                  ...
                  footer={
                    <>
                      ...
                      <JudoooButton variant="default" size="sm" onClick={() => setIsModalOpen(true)}>
                        Preview modal
                      </JudoooButton>
                    </>
                  }
      ...
      <JudoooModal
        ...
        footer={
          <>
            ...
            <JudoooButton variant="default">Continue</JudoooButton>
          </>
        }
      >
